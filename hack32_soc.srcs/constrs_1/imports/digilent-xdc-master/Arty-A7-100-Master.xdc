...
create_clock -name sys_clk_pin -period 10.00 -waveform {0 5} -add [get_ports { mainclk }];
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { mainrst }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
